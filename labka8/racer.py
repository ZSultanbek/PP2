...
class Player(pygame.sprite.Sprite):
    def __init__(self):
        ...
        self.width = 100
        self.height = 50
        self.image = pygame.image.load(r"labka8\images1\player.png")
...
class Coin(pygame.sprite.Sprite):
    def __init__(self, speed=None):
        super().__init__()
        self.image = pygame.image.load(r"labka8\images1\coin.png")
        self.rect = self.image.get_rect()
        self.rect.center = (random.randint(10, width_screen-100), -200)
        if speed==None:
            speed = 2
...
background = pygame.image.load(r"labka8\images1\infroad.png")
background2 = pygame.image.load(r"labka8\images1\infroad.png")
...
#background music
pygame.mixer_music.load(r"labka8\songs1\Jumpsuit in D minor harmonic.mp3")
